...
namespace Mvp.Xml.Common.XPath
{
	...
	{
	    private readonly IDictionary<string, IXsltContextVariable> variables =
		...
		{
		    variables.TryGetValue(name, out IXsltContextVariable var);
			return var;
		}
		...
		/// </summary>
	    private class DynamicVariable : IXsltContextVariable
		{
